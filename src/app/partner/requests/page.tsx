...
export default function RequestsPage() {
  ...
  const { data, error } = await supabase
    ...
    .is('assigned_partner_employee_id', null)
  ...
  setRequests(data || [])
    ...
    // حساب الإحصائيات
const readyCount = requests.filter(r => r.base_price && r.base_price > 0).length
const needsQuoteCount = requests.filter(r => !r.base_price || r.base_price === 0).length
